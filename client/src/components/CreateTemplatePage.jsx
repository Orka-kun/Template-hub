...
function CreateTemplatePage() {
  ...
  return (
    <div className="container mx-auto p-6 min-h-screen" style={{ backgroundColor: `var(--div-bg-color)` }}>
      <h1 className="text-3xl md:text-4xl font-extrabold  bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 animate-fade-in text-center mb-8"
      style={{
      ...
      <form onSubmit={handleSubmit} className="space-y-8 max-w-2xl mx-auto">
        <div className="p-6 rounded-xl shadow-lg space-y-4 border border-gray-200 dark:border-gray-600" style={{ backgroundColor: `var(--card-bg)` }}>
          <div>
            <label className="block font-semibold mb-2" style={{ color: `var(--card-text)` }}>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full p-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm transition-all duration-300 min-h-[120px]"
              style={{
                backgroundColor: `var(--bg-color)`,
                color: `var(--text-color)`,
                borderColor: `var(--border-color)`,
        ...
        <div className="p-6 rounded-xl shadow-lg space-y-4 border border-gray-200 dark:border-gray-600" style={{ backgroundColor: `var(--card-bg)` }}>
          <h2 className="text-xl font-semibold border-b-2 border-blue-500 pb-2" style={{ color: `var(--card-text)` }}>
            {t('create_template.fields')}
          </h2>
          {fields.map((field, index) => (
            <div key={index} className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-3 sm:space-y-0 p-4 rounded-lg" style={{ backgroundColor: `var(--bg-color)` }}>
              <input
                type="text"
                placeholder={t('create_template.field_label')}
                value={field.label}
                onChange={(e) => handleFieldChange(index, 'label', e.target.value)}
                className="w-full sm:flex-1 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm transition-all duration-300"
                style={{
                  backgroundColor: `var(--bg-color)`,
                  color: `var(--text-color)`,
                  borderColor: `var(--border-color)`,
              ...
              <select
                ...
                className="w-full sm:w-40 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm transition-all duration-300"
                style={{
                  backgroundColor: `var(--bg-color)`,
                  color: `var(--text-color)`,
                  borderColor: `var(--border-color)`,
              ...
              <label className="flex items-center space-x-2" style={{ color: `var(--card-text)` }}>
                <input
                  type="checkbox"
          ...
          <button
            ...
            className="w-full sm:w-auto px-6 py-3 rounded-full transition-colors shadow-lg transform hover:-translate-y-1"
            style={{
        ...
        <div className="text-center">
          <button
            ...
            className="px-8 py-3 rounded-full transition-colors shadow-lg transform hover:-translate-y-1 disabled:cursor-not-allowed disabled:transform-none"
            style={{
              backgroundColor: isSubmitting ? '#2dd4bf' : '#3E3232',
              color: '#ffffff',
            }}
            onMouseOver={(e) => !isSubmitting && (e.currentTarget.style.backgroundColor = '#503C3C')}
            onMouseOut={(e) => !isSubmitting && (e.currentTarget.style.backgroundColor = '#3E3232')}
          >
