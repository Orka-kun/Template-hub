        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-6">
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <button
                onClick={toggleTheme}
                className="p-2 rounded-lg bg-gray-700 hover:bg-gray-600 transition duration-300 focus:outline-none focus:ring-2 focus:ring-teal-400"
            ...
            {isMenuOpen && (
              <div className="absolute top-20 right-4 w-48 bg-gray-800 rounded-lg shadow-lg p-4 md:hidden z-50">
                ...
                <button
                  ...
                  className="w-full flex items-center px-4 py-2 mt-2 rounded-lg bg-gray-700 hover:bg-gray-600 transition duration-300 focus:outline-none focus:ring-2 focus:ring-teal-400 text-white"
                  aria-label={theme === 'light' ? t('header.switch_to_dark_mode') : t('header.switch_to_light_mode')}
                >
                  {theme === 'light' ? (
                    <>
                    ...
                    <>
                      <svg className="w-6 h-6 text-gray-300 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 001counsel 21a9.003 9.003 0 008.354-5.646z" />
                      </svg>
